...
public class SpencerMainMenu extends FXGLMenu{
    public SpencerMainMenu(MenuType type){
        ...
        hsButton.setTranslateY(FXGL.getAppHeight() / 2.5 - 40 / 2);
        ...
        exitGameButton.setTranslateY(FXGL.getAppHeight() / 2 - 40 / 2);
    ...
    protected void showScores() throws FileNotFoundException {
        ...
        for (Map.Entry<String, Integer> entry : reverseSorted.entrySet()) {
            ...
            FileInputStream fileInput = new FileInputStream("src/assets/textures/HighScore50Pix.gif"); //FOR LAPTOP
    ...
    public static LinkedHashMap<String, Integer> getHighScoreMap() throws FileNotFoundException {
        File file = new File("src/main/Control/HighScoreLog/TotalScore.txt"); //FOR LAPTOP
